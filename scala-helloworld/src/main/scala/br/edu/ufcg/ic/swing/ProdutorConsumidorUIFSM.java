...
import br.edu.ufcg.ic.akka.java.fsm.Consumidor;
import br.edu.ufcg.ic.akka.java.fsm.Produtor;
import br.edu.ufcg.ic.akka.java.fsm.BufferService;
...
public class ProdutorConsumidorUIFSM {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProdutorConsumidorUIFSM window = new ProdutorConsumidorUIFSM();
	 ...
	 */
	public ProdutorConsumidorUIFSM() {
		initialize();
	}
	...
	private void execute() {
		...
		bufferService = system.actorOf(Props.create(BufferService.class, produtor, consumidor, listenerBuffer), "bufferService");
