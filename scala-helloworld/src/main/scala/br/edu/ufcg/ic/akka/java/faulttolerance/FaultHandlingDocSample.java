...
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.CounterApi.UseStorage;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.CounterServiceApi.CurrentCount;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.CounterServiceApi.Increment;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.CounterServiceApi.ServiceUnavailable;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.StorageApi.Entry;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.StorageApi.Get;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.StorageApi.StorageException;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.StorageApi.Store;
import br.edu.ufcg.ic.akka.java.faulttolerance.FaultHandlingDocSample.WorkerApi.Progress;
...
public class FaultHandlingDocSample {
		...
		public void onReceive(Object msg) {
			...
			if (msg.equals(WorkerApi.Start) && progressListener == null) {
				...
				getContext().system().scheduler().schedule(Duration.Zero(), Duration.create(1, "second"),
						getSelf(), WorkerApi.Do, getContext().dispatcher(), null);
				...
				pipe(ask(counterService, CounterServiceApi.GetCurrentCount, askTimeout).mapTo(classTag(CurrentCount.class))
	...
	public static class CounterService extends UntypedActor {
		 ...
		 * Reconnect after a delay. Watch the child so we receive Terminated
		 * message
		...
		void forwardOrPlaceInBacklog(Object msg) {
			...
			// be sent to the counter when it is initialized.
			if (counter == null) {
